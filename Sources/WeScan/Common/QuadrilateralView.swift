...
final class QuadrilateralView: UIView {
    ...
    public var editable = false {
        didSet {
            ...
            quadLayer.fillColor = editable ? UIColor.blue.withAlphaComponent(0.6).cgColor : UIColor.blue.withAlphaComponent(0.5).cgColor
            guard let quad else {
                return
            }
    ...
    private var isHighlighted = false {
        didSet (oldValue) {
            ...
            quadLayer.fillColor = isHighlighted ? UIColor.clear.cgColor : UIColor.blue.withAlphaComponent(0.6).cgColor
            if isHighlighted {
